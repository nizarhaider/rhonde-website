      ...
      <main className="flex-1">
        ...
        <section className="relative">
          <div className="absolute inset-0 z-0">
            <Image
              src="/images/buddha_statue_cave.jpg"
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <div className="prose prose-lg max-w-none">
              <p>Discover the rich cultural heritage and stunning landscapes of Northern Sri Lanka. This journey takes you through ancient cities, historical temples, and pristine coastal areas, offering insights into the region's fascinating history and vibrant present.</p>
            </div>
          </div>
        </section>
