        ...
        <section className="py-16 md:py-24 bg-primary text-black">
          <div className="container">
            <div className="flex flex-col items-center text-center">
              ...
              <Button asChild size="lg" className="bg-black text-white hover:bg-white/90">
      ...
      <footer className="border-t bg-muted/50">
        <div className="container py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <Link href="/" className="text-2xl font-bold tracking-wider mb-4 block">
                RONDÈ
              </Link>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <Link href="mailto:info@ronde.com" className="text-sm text-muted-foreground hover:text-foreground">
                    Email
                  </Link>
                </li>
                <li className="flex items-center gap-2">
          ...
          <div className="border-t mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} RONDÈ. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
